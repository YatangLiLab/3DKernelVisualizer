...
from optvis.objectives_util import _make_arg_str, _extract_act_pos, _T_handle_batch
...
@wrap_objective()
def neuron(layer, n_channel, t=None, x=None, y=None, batch=None):
    ...
    def inner(model):
        layer_t = model(layer)
        layer_t = _extract_act_pos(layer_t, t, x, y)
